  ...
  about: {
    ...
    projects: [
      ...
      },
      {
        title: '무인매장 지도',
        description:
          '네이버 지도 API를 사용했으며 검색, 필터, 상세정보 등을 제공하며 zoom레벨 별 커스텀 클러스터링이 적용되어 렌더링 시 이미지 다운로드 최적화를 적용했습니다. 실제 무인매장이 얼마나 있고, 어떤 종류가 있는지 시각적으로 파악하기 위한 프로젝트입니다. 서비스 홍보물 배포 알바생분들이 지정한 위치로 길을 찾아갈 수 있도록 기능합니다. 브라우니 크루분들이 서비스 현장에 잘 찾아갈 수 있도록 만들어졌습니다. 또한 집 주변 무인매장이 어디에, 얼마나, 어떤게 있는지 궁금한 동네 주민에게 인사이트를 제공해드리기 위해 만들어졌습니다. 모바일 환경 또한 지원합니다.',
